...
const getCityByStateId = (0, catchAsync_1.catchAsync)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    (0, sendResponse_1.sendResponse)(res, {
        success: true,
        statusCode: 200,
        message: "City route",
        data: yield city_service_1.CityService.getCityByStateId(req.params.stateId),
    });
}));
